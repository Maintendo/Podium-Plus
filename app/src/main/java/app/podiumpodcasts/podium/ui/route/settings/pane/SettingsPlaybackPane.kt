...
fun SettingsPlaybackPane(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                val autoQueue = vm.repository.behavior.autoQueue.collectAsState(true)

                SettingsSwitchListItem(
                    checked = autoQueue.value,
                    onCheckedChange = {
                        scope.launch {
                            vm.repository.behavior.setAutoQueue(it)
                        }
                    },
                    ...
                    icon = {
                        Icon(
                            ...
                            stringResource(R.string.route_settings_player_auto_queue)
                        )
                    },
                    label = stringResource(R.string.route_settings_player_auto_queue),
                    description = stringResource(R.string.route_settings_player_auto_queue_description),
