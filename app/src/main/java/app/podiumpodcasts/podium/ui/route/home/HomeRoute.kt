                                ...
                                Section(
                                    ...
                                    Column(
                                        ...
                                        repeat(count) {
                                            ...
                                            val subsequentList = remember<List<PodcastEpisodeBundle>>(continuePlayingPager, it) {
                                                val list = mutableListOf<PodcastEpisodeBundle>()
                                                for (i in (it + 1) until count) {
                                                    continuePlayingPager.peek(i)?.let { bundle ->
                                                        list.add(bundle.toPodcastEpisodeBundle())
                                                    }
                                                }
                                                list
                                            }
                                            ...
                                            PodcastEpisodeListItem(
                                                ...
                                                subsequentEpisodes = subsequentList,
                                ...
                                Section(
                                    ...
                                    Column(
                                        ...
                                        repeat(count) {
                                            ...
                                            val subsequentList = remember<List<PodcastEpisodeBundle>>(newEpisodesPager, it) {
                                                val list = mutableListOf<PodcastEpisodeBundle>()
                                                for (i in (it + 1) until count) {
                                                    newEpisodesPager.peek(i)?.let { bundle ->
                                                        list.add(bundle)
                                                    }
                                                }
                                                list
