            ...
            LazyColumn(
                ...
                items(
                    ...
                    SwipeableItem(
                        ...
                        val subsequentList = remember<List<PodcastEpisodeBundle>>(continuePlaying, it) {
                            val list = mutableListOf<PodcastEpisodeBundle>()
                            for (i in (it + 1) until continuePlaying.itemCount) {
                                continuePlaying.peek(i)?.let { bundle ->
