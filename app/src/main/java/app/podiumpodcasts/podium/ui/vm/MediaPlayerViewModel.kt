...
class MediaPlayerViewModel : ViewModel() {
    ...
    var isAutoQueueEnabled by mutableStateOf(true)
    ...
    fun play(
        ...
        subsequentEpisodes: List<PodcastEpisodeBundle> = emptyList()
    ) {
        ...
        if (isAutoQueueEnabled && subsequentEpisodes.isNotEmpty()) {
            subsequentEpisodes.forEach { subsequent ->
                val nextMediaItem = subsequent.episode.createMediaItem(context)
    ...
    fun passSettingsRepository(settingsRepository: SettingsRepository) {
        this.settingsRepository = settingsRepository
        viewModelScope.launch {
            settingsRepository.behavior.autoQueue.collect {
